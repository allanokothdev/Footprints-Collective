...
const features = [
  {
    title: 'Discover your Footprint',
    description:
      "Keep track of everyone's salaries and whether or not they've been paid. Direct deposit not supported.",
    image: screenshotPayroll,
  },
  {
    title: 'Offset your Brands Footprint',
    description:
...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-darkGreen pb-28 pt-20 sm:py-32"
    >
      <Image
        className="absolute left-1/2 top-1/2 max-w-none translate-x-[-44%] translate-y-[-42%] bg-darkGreen"
        alt=""
        width={2245}
        height={1636}
        unoptimized
