    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-darkGreen">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-darkGreen/70"
          ...
          <span className="relative">Big Impact</span>
        </span>{' '}
         Your efforts drive grassroots climate adaptation.
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-darkGreen group-active:fill-current"
          >
