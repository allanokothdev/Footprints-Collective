                ...
                <div className='flex justify-between items-center px-3 h-16 border-b border-solid'>
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="./communities" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-darkGreen hover:font-semibold dark:text-gray-400 dark:hover:text-white">
