                ...
                <div className='flex justify-between items-center px-3 h-16 border-b border-solid'>
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        <li className="inline-flex items-center">
                            <Link href="./communities" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-darkGreen dark:text-gray-400 dark:hover:text-white">
                    ...
                    <div className="w-full mx-auto">
                        ...
                        <div className="w-full">
                            ...
                            <div className='flex justify-between items-center px-3 py-3'>
                                ...
                                <button className="inline-flex items-center w-full px-6 py-3 text-sm font-bold leading-4 text-white bg-darkGreen md:px-3 md:w-auto md:rounded-full lg:px-5 hover:bg-mediumGreen focus:outline-none md:focus:ring-2 focus:ring-0 focus:ring-offset-2 focus:ring-darkGreen" type="button">Edit Community</button>
                            </div>
                        </div>
                        ...
                        <div className="p-5 flex flex-col">
                            ...
                            <nav aria-label='tabs' className="flex flex-col sm:flex-row justify-between mb-2">
                                <button role='tab' aria-selected="true" aria-controls='panel-1' id='tab-1' tabIndex={0} className="text-gray-600 py-4 px-6 w-full block hover:text-darkGreen hover:font-semibold focus:outline-none border-b-2 font-medium border-darkGreen">
                                    Activities
                                </button>
                                <button role='tab' aria-selected="false" aria-controls='panel-2' id='tab-2' tabIndex={-1} className="text-gray-600 py-4 px-6 w-full block hover:text-darkGreen hover:font-semibold focus:outline-none">
                                    Offsets
                                </button>
                                <button role='tab' aria-selected="false" aria-controls='panel-3' id='tab-3' tabIndex={-2} className="text-gray-600 py-4 px-6 w-full block hover:text-darkGreen hover:font-semibold focus:outline-none">
                                    Members
                                </button>
                                <button role='tab' aria-selected="false" aria-controls='panel-4' id='tab-4' tabIndex={-3} className="text-gray-600 py-4 px-6 w-full block hover:text-darkGreen hover:font-semibold focus:outline-none">
                                    Requests
                                </button>
                            </nav>
                            ...
                            <div>
                                ...
                                <ul className="flex flex-1 flex-col gap-y-4 overflow-auto">
                                    {General.activities.map(({ id, pic, title, summary, timestamp, location, status, budget, category, communityTitle, publisher_id, comments, upvotes, downvotes }) => (
                                        <div className="flex flex-col w-full bg-white rounded shadow-lg">
                                            ...
                                            <div className='flex flex-row justify-between p-4'>
                                                ...
                                                <button type="button" className="text-white bg-darkGreen hover:bg-middleGreen focus:ring-4 focus:outline-none focus:ring-lightGreen font-medium rounded-full  text-sm px-10 py-2.5 text-center inline-flex items-center"  >
                                                    <div className="text-sm font-semibold">{downvotes}</div>
                                                    <span className=" py-4 text-2xl mx-5 text-gray-100 border-l-2 border-gray-100 font-mono"></span>
