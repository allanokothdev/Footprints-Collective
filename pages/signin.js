              ...
              <div className="w-full h-100">
                  ...
                  <form className="mt-6" action="#" method="POST">
                      ...
                      <div className="mt-4">
                          ...
                          <input type="password" name="" id="" placeholder="Enter Password" minLength={6} className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-darkGreen focus:ring-darkGreen focus:bg-white focus:outline-none" autoComplete='password' required=""/>
                      </div>
                      ...
                      <button type="submit" className="w-full block bg-darkGreen hover:bg-mediumGreen focus:bg-mediumGreen text-white font-semibold rounded-lg px-4 py-3 mt-6"  > Log In </button>
                  </form>
